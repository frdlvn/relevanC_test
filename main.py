...
raw_df = spark.read.option("header", "true").option("sep", "|").csv("relevanC/randomized-transactions-202009.psv")
...
top_50_stores_df.write.save("relevanC/top-50-stores", header="true", format="csv", mode="overwrite", sep="|")
...
sns_plot.get_figure().savefig("relevanC/top-50-stores/top-50-stores.png")
plt.close()
